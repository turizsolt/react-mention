    ...
    InputMention.prototype.render = function () {
        ...
        return (React.createElement("div", { className: InputMentionStyles_1.styles.outerDiv },
            React.createElement("textarea", { placeholder: this.props.placeholder, onBlur: function (event) { if (_this.props.onBlur)
                    _this.props.onBlur(event); }, ref: this.refTextArea, onKeyDown: this.onKeyDown, onKeyUp: this.onKeyUp, onChange: this.onTextChange, onClick: this.onTextClick, value: this.state.text }),
